...
from authentication.v1.serializers.token import TokenSerializer, RefreshAccessTokenSerializer, \
...
class VerifyTokenView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            ...
            400: OpenApiResponse(response=VerifyTokenBadRequestSerializer),
...
class BanRefreshTokenView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            ...
            400: OpenApiResponse(response=RefreshTokenBadRequest),
            406: OpenApiResponse(response=InvalidTokenSerializer),
        },
        tags=SCHEMA_TAGS)
    def post(self, request):
